                    ...
                    <View style={{ height:225, marginBottom: 30 }}>
                        <View style={styles.trackRowContainer}>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/food0.png")}
                            ...
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/food1.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                        </View>
                        <View style={styles.trackRowContainer}>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/food2.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/food3.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                    </View>
