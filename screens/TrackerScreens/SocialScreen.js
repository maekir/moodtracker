                    ...
                    <View style={{ height:225, marginBottom: 30 }}>
                        <View style={styles.trackRowContainer}>
                            <TouchableOpacity 
                                ...
                                onLongPress={() => Alert.alert(
                                    "Conflict", 
                                    "You had a fight or an argument. Either way, something blew up."
                                    )
                                }>
                                <Image
                                    source={require("../../assets/images/TrackerImages/social0.png")}
                            ...
                            <TouchableOpacity 
                                ...
                                onLongPress={() => Alert.alert(
                                    "Supportive", 
                                    "You were a decent enough friend!"
                                    )
                                }>
                                <Image
                                    source={require("../../assets/images/TrackerImages/social1.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                        </View>
                        <View style={styles.trackRowContainer}>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/social2.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/social3.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                    </View>
