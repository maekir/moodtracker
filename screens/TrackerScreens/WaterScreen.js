                    ...
                    <View style={{ height:225, marginBottom: 30 }}>
                        <View style={styles.trackRowContainer}>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/water0.png")}
                            ...
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/water1.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                        </View>
                        <View style={styles.trackRowContainer}>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/water2.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                            <TouchableOpacity 
                                ...
                                <Image
                                    source={require("../../assets/images/TrackerImages/water3.png")}
                                    style={styles.imageStyle}
                                />
                            </TouchableOpacity>
                    </View>
